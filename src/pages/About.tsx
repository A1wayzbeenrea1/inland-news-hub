...
const About = () => {
  return (
    <>
      <MetaTags 
        title="About Us | Inland Empire News Hub"
        description="Learn more about the Inland Empire News Hub, our mission, values, and the team behind your trusted source for local news."
      />
      <Header />
      <main className="container mx-auto py-8 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-6">About Inland Empire News Hub</h1>
          
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">Our Mission</h2>
            <p className="text-gray-700 mb-4">
              At Inland Empire News Hub, our mission is to provide accurate, timely, and relevant news coverage 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Founded in 2023, Inland Empire News Hub emerged from a recognition that our communities needed 
