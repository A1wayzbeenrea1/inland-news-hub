...
export const articles: Article[] = [
  ...
  },
  {
    ...
    <p>Construction is expected to take 18 months, with the first residents moving in by early 2025. A waiting list for applications will open six months before completion.</p>
